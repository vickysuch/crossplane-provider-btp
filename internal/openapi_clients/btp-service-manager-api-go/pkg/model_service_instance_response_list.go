...
// checks if the ServiceInstanceResponseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceInstanceResponseList{}

// ServiceInstanceResponseList struct for ServiceInstanceResponseList
...
// NewServiceInstanceResponseList instantiates a new ServiceInstanceResponseList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewServiceInstanceResponseList() *ServiceInstanceResponseList {
	this := ServiceInstanceResponseList{}
	return &this
}

// NewServiceInstanceResponseListWithDefaults instantiates a new ServiceInstanceResponseList object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewServiceInstanceResponseListWithDefaults() *ServiceInstanceResponseList {
	this := ServiceInstanceResponseList{}
	return &this
}

// GetItems returns the Items field value if set, zero value otherwise.
func (o *ServiceInstanceResponseList) GetItems() []ListedServiceInstanceResponseObject {
	if o == nil || IsNil(o.Items) {
		var ret []ListedServiceInstanceResponseObject
		return ret
	}
	return o.Items
}
...
func (o *ServiceInstanceResponseList) GetItemsOk() ([]ListedServiceInstanceResponseObject, bool) {
	if o == nil || IsNil(o.Items) {
		return nil, false
	}
	return o.Items, true
...
func (o *ServiceInstanceResponseList) HasItems() bool {
	if o != nil && !IsNil(o.Items) {
		return true
	}
...
// SetItems gets a reference to the given []ListedServiceInstanceResponseObject and assigns it to the Items field.
func (o *ServiceInstanceResponseList) SetItems(v []ListedServiceInstanceResponseObject) {
	o.Items = v
}

// GetNumItems returns the NumItems field value if set, zero value otherwise.
func (o *ServiceInstanceResponseList) GetNumItems() int32 {
...
// and a boolean to check if the value has been set.
func (o *ServiceInstanceResponseList) GetNumItemsOk() (*int32, bool) {
	if o == nil || IsNil(o.NumItems) {
		return nil, false
	}
...
func (o *ServiceInstanceResponseList) HasNumItems() bool {
	if o != nil && !IsNil(o.NumItems) {
		return true
	}
...
func (o *ServiceInstanceResponseList) SetNumItems(v int32) {
	o.NumItems = &v
}

// GetToken returns the Token field value if set, zero value otherwise.
func (o *ServiceInstanceResponseList) GetToken() string {
...
// and a boolean to check if the value has been set.
func (o *ServiceInstanceResponseList) GetTokenOk() (*string, bool) {
	if o == nil || IsNil(o.Token) {
		return nil, false
	}
	return o.Token, true
...
func (o *ServiceInstanceResponseList) HasToken() bool {
	if o != nil && !IsNil(o.Token) {
		return true
	}
...
func (o *ServiceInstanceResponseList) SetToken(v string) {
	o.Token = &v
}

func (o ServiceInstanceResponseList) MarshalJSON() ([]byte, error) {
...
func (o ServiceInstanceResponseList) ToMap() (map[string]interface{}, error) {
...
type NullableServiceInstanceResponseList struct {
	value *ServiceInstanceResponseList
	isSet bool
}

func (v NullableServiceInstanceResponseList) Get() *ServiceInstanceResponseList {
	return v.value
}

func (v *NullableServiceInstanceResponseList) Set(val *ServiceInstanceResponseList) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceInstanceResponseList) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceInstanceResponseList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceInstanceResponseList(val *ServiceInstanceResponseList) *NullableServiceInstanceResponseList {
	return &NullableServiceInstanceResponseList{value: val, isSet: true}
}

func (v NullableServiceInstanceResponseList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceInstanceResponseList) UnmarshalJSON(src []byte) error {
	v.isSet = true
