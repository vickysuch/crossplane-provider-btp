...
func (mg *SubaccountServiceBinding) GetTerraformResourceType() string {
	return "btp_subaccount_service_binding"
}
...
func (tr *SubaccountServiceBinding) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"credentials": "status.atProvider.credentials"}
}
...
// LateInitialize this SubaccountServiceBinding using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *SubaccountServiceBinding) LateInitialize(attrs []byte) (bool, error) {
	params := &SubaccountServiceBindingParameters{}
