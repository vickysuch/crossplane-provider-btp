...
func Setup(mgr ctrl.Manager, o controller.Options) error {
	return providerconfig.DefaultSetup(mgr, o, &oidcapisv1alpha1.CertBasedOIDCLogin{}, oidcapisv1alpha1.CertBasedOIDCLoginGroupKind, oidcapisv1alpha1.CertBasedOIDCLoginGroupVersionKind, func(kube client.Client, usage resource.Tracker, resourcetracker tracking.ReferenceResolverTracker, btpNewServiceFn func(cisSecretData []byte, serviceAccountSecretData []byte) (*btp.Client, error)) managed.ExternalConnecter {
		return &connector{
			kube: mgr.GetClient(),
