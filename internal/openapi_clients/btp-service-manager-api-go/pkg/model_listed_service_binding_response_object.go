...
// checks if the ListedServiceBindingResponseObject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListedServiceBindingResponseObject{}

// ListedServiceBindingResponseObject struct for ListedServiceBindingResponseObject
...
func NewListedServiceBindingResponseObject() *ListedServiceBindingResponseObject {
	this := ListedServiceBindingResponseObject{}
	return &this
}

// NewListedServiceBindingResponseObjectWithDefaults instantiates a new ListedServiceBindingResponseObject object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListedServiceBindingResponseObjectWithDefaults() *ListedServiceBindingResponseObject {
	this := ListedServiceBindingResponseObject{}
	return &this
}

// GetBindResource returns the BindResource field value if set, zero value otherwise.
func (o *ListedServiceBindingResponseObject) GetBindResource() map[string]string {
...
func (o *ListedServiceBindingResponseObject) GetBindResourceOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.BindResource) {
		return nil, false
	}
...
func (o *ListedServiceBindingResponseObject) HasBindResource() bool {
	if o != nil && !IsNil(o.BindResource) {
		return true
	}
...
func (o *ListedServiceBindingResponseObject) SetBindResource(v map[string]string) {
	o.BindResource = &v
}
...
func (o *ListedServiceBindingResponseObject) HasContext() bool {
	if o != nil && !IsNil(o.Context) {
		return true
	}
...
func (o *ListedServiceBindingResponseObject) GetCreatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ListedServiceBindingResponseObject) GetCreatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.CreatedAt) {
		return nil, false
	}
...
func (o *ListedServiceBindingResponseObject) HasCreatedAt() bool {
	if o != nil && !IsNil(o.CreatedAt) {
		return true
	}
...
func (o *ListedServiceBindingResponseObject) GetCredentials() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *ListedServiceBindingResponseObject) GetCredentialsOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Credentials) {
...
func (o *ListedServiceBindingResponseObject) HasCredentials() bool {
	if o != nil && !IsNil(o.Credentials) {
		return true
	}
...
func (o *ListedServiceBindingResponseObject) SetCredentials(v map[string]interface{}) {
	o.Credentials = v
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *ListedServiceBindingResponseObject) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListedServiceBindingResponseObject) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *ListedServiceBindingResponseObject) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *ListedServiceBindingResponseObject) SetId(v string) {
	o.Id = &v
}

// GetLabels returns the Labels field value if set, zero value otherwise.
func (o *ListedServiceBindingResponseObject) GetLabels() map[string][]string {
...
// and a boolean to check if the value has been set.
func (o *ListedServiceBindingResponseObject) GetLabelsOk() (*map[string][]string, bool) {
	if o == nil || IsNil(o.Labels) {
		return nil, false
	}
...
func (o *ListedServiceBindingResponseObject) HasLabels() bool {
	if o != nil && !IsNil(o.Labels) {
		return true
	}
...
func (o *ListedServiceBindingResponseObject) SetLabels(v map[string][]string) {
	o.Labels = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *ListedServiceBindingResponseObject) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *ListedServiceBindingResponseObject) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *ListedServiceBindingResponseObject) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ListedServiceBindingResponseObject) SetName(v string) {
	o.Name = &v
}

// GetReady returns the Ready field value if set, zero value otherwise.
func (o *ListedServiceBindingResponseObject) GetReady() bool {
...
// and a boolean to check if the value has been set.
func (o *ListedServiceBindingResponseObject) GetReadyOk() (*bool, bool) {
	if o == nil || IsNil(o.Ready) {
		return nil, false
	}
	return o.Ready, true
...
func (o *ListedServiceBindingResponseObject) HasReady() bool {
	if o != nil && !IsNil(o.Ready) {
		return true
	}
...
func (o *ListedServiceBindingResponseObject) SetReady(v bool) {
	o.Ready = &v
}

// GetServiceInstanceId returns the ServiceInstanceId field value if set, zero value otherwise.
func (o *ListedServiceBindingResponseObject) GetServiceInstanceId() string {
...
// and a boolean to check if the value has been set.
func (o *ListedServiceBindingResponseObject) GetServiceInstanceIdOk() (*string, bool) {
	if o == nil || IsNil(o.ServiceInstanceId) {
		return nil, false
	}
...
func (o *ListedServiceBindingResponseObject) HasServiceInstanceId() bool {
	if o != nil && !IsNil(o.ServiceInstanceId) {
		return true
	}
...
func (o *ListedServiceBindingResponseObject) SetServiceInstanceId(v string) {
	o.ServiceInstanceId = &v
}

// GetUpdatedAt returns the UpdatedAt field value if set, zero value otherwise.
func (o *ListedServiceBindingResponseObject) GetUpdatedAt() time.Time {
...
// and a boolean to check if the value has been set.
func (o *ListedServiceBindingResponseObject) GetUpdatedAtOk() (*time.Time, bool) {
	if o == nil || IsNil(o.UpdatedAt) {
		return nil, false
	}
...
func (o *ListedServiceBindingResponseObject) HasUpdatedAt() bool {
	if o != nil && !IsNil(o.UpdatedAt) {
		return true
	}
...
func (o *ListedServiceBindingResponseObject) SetUpdatedAt(v time.Time) {
	o.UpdatedAt = &v
}
...
func (o ListedServiceBindingResponseObject) ToMap() (map[string]interface{}, error) {
...
type NullableListedServiceBindingResponseObject struct {
	value *ListedServiceBindingResponseObject
	isSet bool
}

func (v NullableListedServiceBindingResponseObject) Get() *ListedServiceBindingResponseObject {
	return v.value
}

func (v *NullableListedServiceBindingResponseObject) Set(val *ListedServiceBindingResponseObject) {
	v.value = val
	v.isSet = true
}

func (v NullableListedServiceBindingResponseObject) IsSet() bool {
	return v.isSet
}

func (v *NullableListedServiceBindingResponseObject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListedServiceBindingResponseObject(val *ListedServiceBindingResponseObject) *NullableListedServiceBindingResponseObject {
	return &NullableListedServiceBindingResponseObject{value: val, isSet: true}
}

func (v NullableListedServiceBindingResponseObject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListedServiceBindingResponseObject) UnmarshalJSON(src []byte) error {
	v.isSet = true
