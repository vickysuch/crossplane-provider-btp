...
The [crossplane-provider-btp-account](https://github.com/crossplane/crossplane-provider-btp-account) repository can be
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/crossplane-provider-btp-account/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/crossplane-provider-btp-account/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/crossplane-provider-btp-account/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/crossplane-provider-btp-account/blob/main/hack/boilerplate.go.txt)
...
The [crossplane-provider-btp-account](https://github.com/crossplane/crossplane-provider-btp-account)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/crossplane-provider-btp-account/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/crossplane-provider-btp-account/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue templates (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/crossplane-provider-btp-account/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Templates: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/crossplane-provider-btp-account/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
