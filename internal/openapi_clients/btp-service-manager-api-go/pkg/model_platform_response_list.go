...
// checks if the PlatformResponseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PlatformResponseList{}

// PlatformResponseList struct for PlatformResponseList
...
// NewPlatformResponseList instantiates a new PlatformResponseList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPlatformResponseList() *PlatformResponseList {
	this := PlatformResponseList{}
	return &this
}

// NewPlatformResponseListWithDefaults instantiates a new PlatformResponseList object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPlatformResponseListWithDefaults() *PlatformResponseList {
	this := PlatformResponseList{}
	return &this
}

// GetItems returns the Items field value if set, zero value otherwise.
func (o *PlatformResponseList) GetItems() []ListedPlatformResponseObject {
	if o == nil || IsNil(o.Items) {
		var ret []ListedPlatformResponseObject
		return ret
	}
	return o.Items
}
...
func (o *PlatformResponseList) GetItemsOk() ([]ListedPlatformResponseObject, bool) {
	if o == nil || IsNil(o.Items) {
		return nil, false
	}
	return o.Items, true
...
func (o *PlatformResponseList) HasItems() bool {
	if o != nil && !IsNil(o.Items) {
		return true
	}
...
// SetItems gets a reference to the given []ListedPlatformResponseObject and assigns it to the Items field.
func (o *PlatformResponseList) SetItems(v []ListedPlatformResponseObject) {
	o.Items = v
}

// GetNumItems returns the NumItems field value if set, zero value otherwise.
func (o *PlatformResponseList) GetNumItems() int32 {
...
// and a boolean to check if the value has been set.
func (o *PlatformResponseList) GetNumItemsOk() (*int32, bool) {
	if o == nil || IsNil(o.NumItems) {
		return nil, false
	}
...
func (o *PlatformResponseList) HasNumItems() bool {
	if o != nil && !IsNil(o.NumItems) {
		return true
	}
...
func (o *PlatformResponseList) SetNumItems(v int32) {
	o.NumItems = &v
}

// GetToken returns the Token field value if set, zero value otherwise.
func (o *PlatformResponseList) GetToken() string {
...
// and a boolean to check if the value has been set.
func (o *PlatformResponseList) GetTokenOk() (*string, bool) {
	if o == nil || IsNil(o.Token) {
		return nil, false
	}
	return o.Token, true
...
func (o *PlatformResponseList) HasToken() bool {
	if o != nil && !IsNil(o.Token) {
		return true
	}
...
func (o *PlatformResponseList) SetToken(v string) {
	o.Token = &v
}

func (o PlatformResponseList) MarshalJSON() ([]byte, error) {
...
func (o PlatformResponseList) ToMap() (map[string]interface{}, error) {
...
type NullablePlatformResponseList struct {
	value *PlatformResponseList
	isSet bool
}

func (v NullablePlatformResponseList) Get() *PlatformResponseList {
	return v.value
}

func (v *NullablePlatformResponseList) Set(val *PlatformResponseList) {
	v.value = val
	v.isSet = true
}

func (v NullablePlatformResponseList) IsSet() bool {
	return v.isSet
}

func (v *NullablePlatformResponseList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlatformResponseList(val *PlatformResponseList) *NullablePlatformResponseList {
	return &NullablePlatformResponseList{value: val, isSet: true}
}

func (v NullablePlatformResponseList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlatformResponseList) UnmarshalJSON(src []byte) error {
	v.isSet = true
