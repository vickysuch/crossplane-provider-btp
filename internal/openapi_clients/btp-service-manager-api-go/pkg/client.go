...
// APIClient manages communication with the Service Manager API v1.0
...
type APIClient struct {
	...
	ServiceBindingsAPI ServiceBindingsAPI

	ServiceBrokersAPI ServiceBrokersAPI

	ServiceInstancesAPI ServiceInstancesAPI

	ServiceOfferingsAPI ServiceOfferingsAPI
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.ServiceBrokersAPI = (*ServiceBrokersAPIService)(&c.common)
