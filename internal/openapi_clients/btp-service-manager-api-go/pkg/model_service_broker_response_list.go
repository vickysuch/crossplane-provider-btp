...
// checks if the ServiceBrokerResponseList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ServiceBrokerResponseList{}

// ServiceBrokerResponseList struct for ServiceBrokerResponseList
...
// NewServiceBrokerResponseList instantiates a new ServiceBrokerResponseList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewServiceBrokerResponseList() *ServiceBrokerResponseList {
	this := ServiceBrokerResponseList{}
	return &this
}

// NewServiceBrokerResponseListWithDefaults instantiates a new ServiceBrokerResponseList object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewServiceBrokerResponseListWithDefaults() *ServiceBrokerResponseList {
	this := ServiceBrokerResponseList{}
	return &this
}

// GetItems returns the Items field value if set, zero value otherwise.
func (o *ServiceBrokerResponseList) GetItems() []ListedServiceBrokerResponseObject {
	if o == nil || IsNil(o.Items) {
		var ret []ListedServiceBrokerResponseObject
		return ret
	}
	return o.Items
}
...
func (o *ServiceBrokerResponseList) GetItemsOk() ([]ListedServiceBrokerResponseObject, bool) {
	if o == nil || IsNil(o.Items) {
		return nil, false
	}
	return o.Items, true
...
func (o *ServiceBrokerResponseList) HasItems() bool {
	if o != nil && !IsNil(o.Items) {
		return true
	}
...
// SetItems gets a reference to the given []ListedServiceBrokerResponseObject and assigns it to the Items field.
func (o *ServiceBrokerResponseList) SetItems(v []ListedServiceBrokerResponseObject) {
	o.Items = v
}

// GetNumItems returns the NumItems field value if set, zero value otherwise.
func (o *ServiceBrokerResponseList) GetNumItems() int32 {
...
// and a boolean to check if the value has been set.
func (o *ServiceBrokerResponseList) GetNumItemsOk() (*int32, bool) {
	if o == nil || IsNil(o.NumItems) {
		return nil, false
	}
...
func (o *ServiceBrokerResponseList) HasNumItems() bool {
	if o != nil && !IsNil(o.NumItems) {
		return true
	}
...
func (o *ServiceBrokerResponseList) SetNumItems(v int32) {
	o.NumItems = &v
}

// GetToken returns the Token field value if set, zero value otherwise.
func (o *ServiceBrokerResponseList) GetToken() string {
...
// and a boolean to check if the value has been set.
func (o *ServiceBrokerResponseList) GetTokenOk() (*string, bool) {
	if o == nil || IsNil(o.Token) {
		return nil, false
	}
	return o.Token, true
...
func (o *ServiceBrokerResponseList) HasToken() bool {
	if o != nil && !IsNil(o.Token) {
		return true
	}
...
func (o *ServiceBrokerResponseList) SetToken(v string) {
	o.Token = &v
}

func (o ServiceBrokerResponseList) MarshalJSON() ([]byte, error) {
...
func (o ServiceBrokerResponseList) ToMap() (map[string]interface{}, error) {
...
type NullableServiceBrokerResponseList struct {
	value *ServiceBrokerResponseList
	isSet bool
}

func (v NullableServiceBrokerResponseList) Get() *ServiceBrokerResponseList {
	return v.value
}

func (v *NullableServiceBrokerResponseList) Set(val *ServiceBrokerResponseList) {
	v.value = val
	v.isSet = true
}

func (v NullableServiceBrokerResponseList) IsSet() bool {
	return v.isSet
}

func (v *NullableServiceBrokerResponseList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServiceBrokerResponseList(val *ServiceBrokerResponseList) *NullableServiceBrokerResponseList {
	return &NullableServiceBrokerResponseList{value: val, isSet: true}
}

func (v NullableServiceBrokerResponseList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServiceBrokerResponseList) UnmarshalJSON(src []byte) error {
	v.isSet = true
